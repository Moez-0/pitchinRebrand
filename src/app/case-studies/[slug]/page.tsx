            ...
            <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden">
                ...
                <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-8">
                    <div className="mb-10 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                        ...
                        />
                        <ClientPdfButton title={study.company} />
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
                            ...
                            {study.testimonial && (
                                <div className="relative bg-zinc-900/40 border border-zinc-800 rounded-2xl p-8 sm:p-10 mt-12">
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <div>
                                            <div className="text-primary font-medium">{study.testimonial.author}</div>
                                            <div className="text-sm text-zinc-500">{study.testimonial.role}</div>
                                        </div>
                                    </div>
                                </div>
                            )}
                        ...
                        <div className="lg:col-span-4">
                            <div className="bg-zinc-900/30 border border-zinc-800 rounded-2xl p-8 sticky top-32">
                                <h4 className="text-sm text-white font-semibold uppercase tracking-wider mb-6">Technologies Used</h4>
                                ...
                                <div className="pt-8 border-t border-zinc-800/50">
                                    <h4 className="text-sm text-white font-semibold uppercase tracking-wider mb-4">Want similar results?</h4>
                                    <p className="text-sm text-zinc-500 mb-6">Let's discuss how we can help your company scale its engineering capabilities.</p>
                                    <Link
                                        href="/contact"
